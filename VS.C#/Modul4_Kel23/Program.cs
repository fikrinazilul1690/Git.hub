...
namespace Modul4_Kel23
{
    class Program
    {
        /*static void non_return(String a, String b, String c)
        {
            Console.WriteLine("Selamat Datang di Praktikum DKP 2020\n{0} dan {1} adalah {2}", a, b, c);
        }
        ...
        static void Main(string[] args)
        {
            ...
            //non_return("Dimas Seto", "Achmad Nazilul Fikri", "Kelompok 23");
